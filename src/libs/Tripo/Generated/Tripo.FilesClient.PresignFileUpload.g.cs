...
namespace Tripo
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Tripo.EndPointSecurityRequirement s_PresignFileUploadSecurityRequirement0 =
        ...
        private static readonly global::Tripo.EndPointSecurityRequirement[] s_PresignFileUploadSecurityRequirements =
            new global::Tripo.EndPointSecurityRequirement[]
            {                s_PresignFileUploadSecurityRequirement0,
            };
        partial void PreparePresignFileUploadArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Tripo.PresignFileUploadRequest request);
        partial void PreparePresignFileUploadRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Tripo.PresignFileUploadRequest request);
        partial void ProcessPresignFileUploadResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPresignFileUploadResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Tripo.PresignFileUploadResponse> PresignFileUploadAsync(

            global::Tripo.PresignFileUploadRequest request,
            global::Tripo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PresignFileUploadAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Tripo.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Tripo.AutoSDKHttpResponse<global::Tripo.PresignFileUploadResponse>> PresignFileUploadAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePresignFileUploadArguments(
            ...
            var __authorizations = global::Tripo.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PresignFileUploadSecurityRequirements,
                operationName: "PresignFileUploadAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePresignFileUploadRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Tripo.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Tripo.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PresignFileUploadAsync",
                                pathTemplate: "\"/files/presign\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPresignFileUploadResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Tripo.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPresignFileUploadResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Tripo.PresignFileUploadResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Tripo.AutoSDKHttpResponse<global::Tripo.PresignFileUploadResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Tripo.PresignFileUploadResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Tripo.PresignFileUploadResponse> PresignFileUploadAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Tripo.PresignFileUploadRequest
            {
                Format = format,
            };

            return await PresignFileUploadAsync(
                request: __request,
                requestOptions: requestOptions,
