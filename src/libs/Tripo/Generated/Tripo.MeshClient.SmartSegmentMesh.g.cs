...
namespace Tripo
{
    public partial class MeshClient
    {
        ...
        private static readonly global::Tripo.EndPointSecurityRequirement s_SmartSegmentMeshSecurityRequirement0 =
        ...
        private static readonly global::Tripo.EndPointSecurityRequirement[] s_SmartSegmentMeshSecurityRequirements =
            new global::Tripo.EndPointSecurityRequirement[]
            {                s_SmartSegmentMeshSecurityRequirement0,
            };
        partial void PrepareSmartSegmentMeshArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Tripo.SmartSegmentMeshRequest request);
        partial void PrepareSmartSegmentMeshRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Tripo.SmartSegmentMeshRequest request);
        partial void ProcessSmartSegmentMeshResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSmartSegmentMeshResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Tripo.TaskCreatedResponse> SmartSegmentMeshAsync(

            global::Tripo.SmartSegmentMeshRequest request,
            global::Tripo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SmartSegmentMeshAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Tripo.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Tripo.AutoSDKHttpResponse<global::Tripo.TaskCreatedResponse>> SmartSegmentMeshAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSmartSegmentMeshArguments(
            ...
            var __authorizations = global::Tripo.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SmartSegmentMeshSecurityRequirements,
                operationName: "SmartSegmentMeshAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSmartSegmentMeshRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Tripo.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Tripo.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SmartSegmentMesh",
                                methodName: "SmartSegmentMeshAsync",
                                pathTemplate: "\"/mesh/smartsegment\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSmartSegmentMeshResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Tripo.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSmartSegmentMeshResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Tripo.TaskCreatedResponse> SmartSegmentMeshAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Tripo.SmartSegmentMeshRequest
            {
                SegType = segType,
                Input = input,
            ...
            return await SmartSegmentMeshAsync(
                request: __request,
                requestOptions: requestOptions,
