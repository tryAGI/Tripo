...
namespace Tripo
{
    public partial class AnimationClient
    {
        ...
        private static readonly global::Tripo.EndPointSecurityRequirement s_RigCheckSecurityRequirement0 =
        ...
        private static readonly global::Tripo.EndPointSecurityRequirement[] s_RigCheckSecurityRequirements =
            new global::Tripo.EndPointSecurityRequirement[]
            {                s_RigCheckSecurityRequirement0,
            };
        partial void PrepareRigCheckArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Tripo.RigCheckRequest request);
        partial void PrepareRigCheckRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Tripo.RigCheckRequest request);
        partial void ProcessRigCheckResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRigCheckResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await RigCheckAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Tripo.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Tripo.AutoSDKHttpResponse<global::Tripo.TaskCreatedResponse>> RigCheckAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Tripo.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RigCheckSecurityRequirements,
                operationName: "RigCheckAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Tripo.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Tripo.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RigCheck",
                                methodName: "RigCheckAsync",
                                pathTemplate: "\"/animations/rig-check\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Tripo.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRigCheckResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
