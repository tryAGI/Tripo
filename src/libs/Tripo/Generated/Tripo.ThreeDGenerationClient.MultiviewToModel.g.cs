...
namespace Tripo
{
    public partial class ThreeDGenerationClient
    {
        ...
        private static readonly global::Tripo.EndPointSecurityRequirement s_MultiviewToModelSecurityRequirement0 =
        ...
        private static readonly global::Tripo.EndPointSecurityRequirement[] s_MultiviewToModelSecurityRequirements =
            new global::Tripo.EndPointSecurityRequirement[]
            {                s_MultiviewToModelSecurityRequirement0,
            };
        partial void PrepareMultiviewToModelArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Tripo.MultiviewToModelRequest request);
        partial void PrepareMultiviewToModelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Tripo.MultiviewToModelRequest request);
        partial void ProcessMultiviewToModelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMultiviewToModelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Tripo.TaskCreatedResponse> MultiviewToModelAsync(

            global::Tripo.MultiviewToModelRequest request,
            global::Tripo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await MultiviewToModelAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Tripo.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Tripo.AutoSDKHttpResponse<global::Tripo.TaskCreatedResponse>> MultiviewToModelAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareMultiviewToModelArguments(
            ...
            var __authorizations = global::Tripo.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_MultiviewToModelSecurityRequirements,
                operationName: "MultiviewToModelAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareMultiviewToModelRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Tripo.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Tripo.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "MultiviewToModel",
                                methodName: "MultiviewToModelAsync",
                                pathTemplate: "\"/generation/multiview-to-model\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMultiviewToModelResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Tripo.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMultiviewToModelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Tripo.TaskCreatedResponse> MultiviewToModelAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Tripo.MultiviewToModelRequest
            {
                Inputs = inputs,
            ...
            return await MultiviewToModelAsync(
                request: __request,
                requestOptions: requestOptions,
