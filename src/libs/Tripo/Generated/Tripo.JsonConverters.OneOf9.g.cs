...
{
    /// <inheritdoc />
    public class OneOfJsonConverter<T1, T2, T3, T4, T5, T6, T7, T8, T9> : global::System.Text.Json.Serialization.JsonConverter<global::Tripo.OneOf<T1, T2, T3, T4, T5, T6, T7, T8, T9>>
    {
        /// <inheritdoc />
        public override global::Tripo.OneOf<T1, T2, T3, T4, T5, T6, T7, T8, T9> Read(
        ...
        public override void Write(
            ...
            global::Tripo.OneOf<T1, T2, T3, T4, T5, T6, T7, T8, T9> value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
