...
namespace Tripo
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Tripo.AutoSDKRetryOptions Retry { get; set; } = new global::Tripo.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Tripo.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Tripo.IAutoSDKHook>();
        ...
        public global::Tripo.AutoSDKClientOptions AddHook(
            global::Tripo.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Tripo.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Tripo.AutoSDKClientOptions UseAuthorizationProvider(
            global::Tripo.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Tripo.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Tripo.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Tripo.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Tripo.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Tripo.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Tripo.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Tripo.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Tripo.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Tripo.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Tripo.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Tripo.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Tripo.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Tripo.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Tripo.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Tripo.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Tripo.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Tripo.AutoSDKClientOptions clientOptions,
            global::Tripo.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Tripo.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Tripo.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Tripo.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Tripo.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Tripo.IAutoSDKHook, global::Tripo.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Tripo.AutoSDKHookContext context)
        {
