...
namespace Tripo
{
    public partial class AnimationClient
    {
        ...
        private static readonly global::Tripo.EndPointSecurityRequirement s_RetargetAnimationSecurityRequirement0 =
        ...
        private static readonly global::Tripo.EndPointSecurityRequirement[] s_RetargetAnimationSecurityRequirements =
            new global::Tripo.EndPointSecurityRequirement[]
            {                s_RetargetAnimationSecurityRequirement0,
            };
        partial void PrepareRetargetAnimationArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Tripo.RetargetAnimationRequest request);
        partial void PrepareRetargetAnimationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Tripo.RetargetAnimationRequest request);
        partial void ProcessRetargetAnimationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRetargetAnimationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await RetargetAnimationAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Tripo.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Tripo.AutoSDKHttpResponse<global::Tripo.TaskCreatedResponse>> RetargetAnimationAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRetargetAnimationArguments(
            ...
            var __authorizations = global::Tripo.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RetargetAnimationSecurityRequirements,
                operationName: "RetargetAnimationAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRetargetAnimationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Tripo.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Tripo.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RetargetAnimation",
                                methodName: "RetargetAnimationAsync",
                                pathTemplate: "\"/animations/retarget\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRetargetAnimationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Tripo.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRetargetAnimationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
