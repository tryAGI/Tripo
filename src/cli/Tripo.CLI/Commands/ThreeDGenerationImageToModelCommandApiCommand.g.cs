...
internal static partial class ThreeDGenerationImageToModelCommandApiCommand
{
    ...
    private static Option<bool?> EnableImageAutofix { get; } = CliRuntime.CreateNullableBoolOption(
        name: @"--enable-image-autofix",
        description: @"Automatically improve low-quality input images.");
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::Tripo.ImageToModelRequest>(
                            parseResult,
                            RequestInput,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ThreeDGeneration.ImageToModelAsync(
                                    input: input,
