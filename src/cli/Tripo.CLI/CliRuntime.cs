...
{
    private const string UserSecretsId = "Tripo.CLI";
    private const string UserSecretApiKeyName = "TRIPO_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"TRIPO_API_KEY"];
    private const string CredentialFileDirectoryName = ".tripo";

    public static async global::System.Threading.Tasks.Task<global::Tripo.TripoClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Tripo.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Tripo.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Tripo.TripoClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Tripo.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Tripo.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Tripo.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Tripo.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("TRIPO_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Tripo.ApiException exception)
    {
        var builder = new StringBuilder();
